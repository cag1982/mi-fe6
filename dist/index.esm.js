...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#b3e0e6", backgroundDisabled: "#aaa", contrast: "rgba(224, 224, 224, .12)", invertedContrast: "#FFFFFF", input: "rgba(224, 224, 224, .12)", tertiary: "rgba(224, 224, 224, .08)", text: "rgba(33, 33, 33, .87)", textDisabled: "rgba(33, 33, 33, .38)", textSubtle: "rgba(33, 33, 33, .60)", borderColor: "rgba(33, 33, 33, .12)", card: "rgba(224, 224, 224, .75)", modal: "#b3e0e6", gradients: {
